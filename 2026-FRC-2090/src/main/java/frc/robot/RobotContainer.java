  ...
  public RobotContainer() {
    ...
    try {
      ...
      AutoBuilder.configure(
        ...
        NamedCommands.registerCommand("DropdownIntake", intake.setDropdownPosition(-11.90576171875).withTimeout(0.2));
        NamedCommands.registerCommand("SpinUpShooter", shooter.runAtRPM(2000).withTimeout(3));
        NamedCommands.registerCommand("RunShooterContinuous", shooter.runAtRPM(2000));
        // Pass auto: 4000 RPM
        NamedCommands.registerCommand("SpinUpShooterPass", shooter.runAtRPM(3000).withTimeout(3));
        NamedCommands.registerCommand("RunShooterContinuousPass", shooter.runAtRPM(3000));
        // Score auto: 2250 RPM
        ...
        NamedCommands.registerCommand("Shoot", transfer.transferCommand().withTimeout(3));
