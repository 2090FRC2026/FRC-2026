...
public class Shooter extends SubsystemBase {
  ...
  // Velocity PID constants (tune these for your shooter)
  private static final double kP = 0.11;  // Proportional gain
  ...
  /**
   * Set both motors to a target RPM using velocity PID.
  ...
  public void setRPM(double rpm) {
    ...
    motor2.setControl(velocityControl.withVelocity(-rps)); // Opposite direction
  }
